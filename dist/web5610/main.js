...
module.exports = "<body>\n<nav class=\"navbar fixed-top cl-grey-navbar\">\n  <div class=\"container-fluid\">\n    <div>\n      <a routerLink=\"/user/{{userId}}/website/{{websiteId}}/page\"\n         class=\"navbar-brand cl-text-black cl-icon-padding\">\n        <i class=\"fas fa-angle-left\"></i>\n      </a>\n      <h1 class=\"navbar-brand cl-text-black cl-text-bold cl-text-grey\" href=\"#\">\n        New Page\n      </h1>\n    </div>\n    <a (click)=\"createPage()\" class=\"navbar-brand cl-text-black float-right cl-icon-padding\">\n      <i class=\"fas fa-check\"></i>\n    </a>\n  </div>\n</nav>\n<div class=\"container\">\n  <form class=\"cl-text-padding\">\n    <div class=\"form-group\">\n      <label>Name</label>\n      <input [(ngModel)]=\"newPageName\" name=\"name\" type=\"text\" class=\"form-control\" placeholder=\"Name\">\n    </div>\n    <div class=\"form-group\">\n      <label>Description</label>\n      <input [(ngModel)]=\"newPageDescrption\" name=\"description\" type=\"text\" class=\"form-control\" placeholder=\"Description\">\n    </div>\n  </form>\n</div>\n<nav class=\"navbar fixed-bottom cl-grey-navbar\">\n  <div class=\"container-fluid justify-content-end\">\n    <a routerLink=\"/user/{{userId}}\" class=\"navbar-brand cl-icon-padding cl-text-blue\">\n      <span class=\"fas fa-user\"></span>\n    </a>\n  </div>\n</nav>\n\n</body>\n"
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            _this.userId = params['uid'];
            _this.user = _this.userService.findUserById(params['uid']);
            console.log('user_id =' + _this.userId);
        });
    };
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        var loginUser = this.userService.findUserByCredentials(this.newUsername, this.newPassword);
...
var WebsiteEditComponent = /** @class */ (function () {
    ...
    WebsiteEditComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            console.log('website-edit, user_id =' + _this.userId, ', webstie id =', +_this.web._id);
        });
    };
...
module.exports = "<body>\n<nav class=\"navbar fixed-top cl-blue-navbar\">\n  <div class=\"container-fluid\">\n    <div class=\"float-left\">\n      <a routerLink=\"/user/{{user._id}}\" class=\"navbar-brand cl-icon-padding cl-text-white\">\n        <a  class=\"fas fa-angle-left cl-text-white\"></a>\n      </a>\n      <h1 class=\"cl-text-white navbar-brand cl-text-bold\" href=\"#\">\n        Websites\n      </h1>\n    </div>\n    <a routerLink=\"/user/{{user._id}}/website/new\" class=\"navbar-brand float-right\">\n      <i class=\"fas fa-plus cl-text-white\"></i>\n    </a>\n  </div>\n</nav>\n<ul class=\"websites\">\n  <li *ngFor=\"let website of websites\"\n      class=\"list-group-item cl-list-item-borderless d-flex justify-content-between\">\n    <a routerLink=\"/user/{{user._id}}/website/{{website._id}}/page\" class=\"cl-text-blue\">{{website.name}}</a>\n    <a routerLink=\"/user/{{user._id}}/website/{{website._id}}\" class=\"cl-text-blue\"><span class=\"fas fa-cog cl-text-blue\"></span></a>\n  </li>\n</ul>\n\n<nav class=\"navbar fixed-bottom cl-blue-navbar\">\n  <div class=\"container-fluid justify-content-end\">\n    <a routerLink=\"/user/{{user._id}}\" class=\"navbar-brand cl-icon-padding\">\n      <span class=\"fas fa-user cl-text-white\"></span>\n    </a>\n  </div>\n</nav>\n</body>\n"
...
module.exports = "<body>\n<nav class=\"navbar fixed-top cl-blue-navbar\">\n  <div class=\"row container-fluid\">\n    <div class=\"col-sm-4 d-none d-sm-block\">\n      <a routerLink=\"/user/{{user._id}}/website\" class=\"navbar-brand\">\n        <i class=\"fas fa-angle-left cl-text-white\"></i>\n      </a>\n      <h1 class=\"cl-text-white navbar-brand cl-text-bold\" href=\"#\">\n        Websites\n      </h1>\n      <a  routerLink=\"/user/{{user._id}}/website/new\" class=\"navbar-brand float-right cl-icon-padding\">\n        <i class=\"fas fa-plus cl-text-white\"></i>\n      </a>\n    </div>\n    <div class=\"row col-sm-8\">\n      <a routerLink=\"/user/{{user._id}}/website\" class=\"navbar-brand d-block d-sm-nonefloat-left\">\n        <i class=\"fas fa-angle-left cl-text-white\"></i>\n      </a>\n      <h1 class=\"cl-text-white navbar-brand cl-text-bold float-left\">\n        New Website\n      </h1>\n      <a routerLink=\"/user/{{user._id}}/website\" (click)=\"newWebsite()\"\n         class=\"navbar-brand cl-text-white ml-auto\">\n        <i class=\"fas fa-check cl-text-white\"></i>\n      </a>\n    </div>\n  </div>\n</nav>\n\n<div class=\"row container-fluid\">\n  <div class=\"col-sm-4 d-none d-sm-block \">\n    <ul class=\"websites\">\n      <li *ngFor=\"let website of websites\"\n          class=\"list-group-item cl-list-item-borderless d-flex justify-content-between\">\n        <a routerLink=\"/user/{{user._id}}/website/{{website._id}}/page\" class=\"cl-text-blue\">{{website.name}}</a>\n        <a routerLink=\"/user/{{user._id}}/website/{{website._id}}\" class=\"cl-text-blue\"><span class=\"fas fa-cog\"></span></a>\n      </li>\n    </ul>\n  </div>\n\n  <div class=\"col-sm-8\">\n    <form class=\"cl-text-padding\">\n      <div class=\"form-group cl-text-bold\">\n        <label for=\"website-name\">Name</label>\n        <input [(ngModel)]=\"newWebsiteName\" name=\"name\" type=\"text\" id=\"website-name\" class=\"form-control\" placeholder=\"Name\">\n      </div>\n      <div class=\"form-group cl-text-bold\">\n        <label for=\"description\">Description</label>\n        <textarea [(ngModel)]=\"newWebsiteDescription\" name=\"description\" id=\"description\" class=\"form-control\" rows=\"5\" placeholder=\"Description\"></textarea>\n      </div>\n    </form>\n  </div>\n</div>\n\n<nav class=\"navbar fixed-bottom cl-blue-navbar\">\n  <div class=\"container-fluid justify-content-end\">\n    <a routerLink=\"/user/{{user._id}}\" class=\"navbar-brand cl-icon-padding\">\n      <span class=\"fas fa-user cl-text-white\"></span>\n    </a>\n  </div>\n</nav>\n\n</body>\n"
...
var WidgetImageComponent = /** @class */ (function () {
    function WidgetImageComponent(widgetService, route, router) {
        ...
        this.route = route;
        this.router = router;
        this.widget = new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_2__["WidgetImage"]('', '', '', '', '');
    }
    ...
    WidgetImageComponent.prototype.updateWidget = function () {
        if (this.widgetId === 'undefined') {
            this.newWidget = new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_2__["WidgetImage"]('', 'IMAGE', this.pageId, this.widget.width, this.widget.url);
            this.widgetService.createWidget(this.pageId, this.newWidget);
        }
        else {
            this.newWidget = new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_2__["WidgetImage"](this.widget._id, 'IMAGE', this.pageId, this.widget.width, this.widget.url);
            this.widgetService.updateWidget(this.widget._id, this.newWidget);
        }
        this.router.navigate(['../'], { relativeTo: this.route });
    };
...
var WebsiteService = /** @class */ (function () {
    ...
    WebsiteService.prototype.createWebsite = function (userId, website) {
        ...
        this.websites.push(new _models_website_model_client__WEBPACK_IMPORTED_MODULE_2__["Website"](website._id, website.name, userId, website.description));
        return website;
    };
...
var WidgetService = /** @class */ (function () {
    function WidgetService() {
        ...
        this.widgets = [
            ...
            new _models_widget_model_client__WEBPACK_IMPORTED_MODULE_2__["WidgetImage"]('345', 'IMAGE', '321', '100%', 'http://lorempixel.com/400/200'),
